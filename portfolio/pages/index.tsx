...
const styles = {
  ...
  leftContent: "pt-[75px] mt-[60.5px] flex flex-grow flex-col bg-[#FFE6CF] dark:bg-slate-900 space-y-[15px]",
  righWrapper: "mx-[8px] flex w-[289px] flex-grow flex-col bg-white dark:bg-slate-800 space-y-[15px]",
};
  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.leftWrapper}>
        <div className="absolute top-0 left-0 right-0 mx-auto h-[121.35px] w-[90px] bg-white border-[3px] border-white rounded-full z-10"></div>
...
const SectionContainer = (props:ISectionContainerProps) => {
  return (
    <div className={props.padding ? "flex flex-col text-[#414042] dark:text-slate-300 px-[14px]" : "flex flex-col text-[#414042] dark:text-slate-300" }>
    <div className="flex flex-col mb-[10px] ">
      <span className="h-[1px] bg-[#414042] dark:bg-slate-300"></span>
        <div className="flex items-center py-[5px]">
          ...
          <h3 className={props.icon ? "font-semibold text-xs tracking-[0.15em] mx-[10px]":"font-semibold text-xs tracking-[0.15em]"}>{props.title}</h3>
      </div>
      <span className="h-[1px] bg-[#414042] dark:bg-slate-300"></span>
      </div>
...
const SectionList = () => {
  return (
    ...
    <h4 className="font-semibold text-[10px] tracking-[0.02em]">Bachelor of Computer Science</h4>
    <p className="text-[8px] opacity-70">American University of Ras Al Khaimah, 2014 – 2019</p>
    <ul className="px-[8px] text-[8px] list-disc space-y-[4px]">
...
const SectionItem = () => {
  return (
    ...
    <p className="text-[9px] opacity-80">Highly passionate about programming languages and technologies, eager to learn and discover new dimensions, flexible and adaptable to changes, and able to perform independently.</p>
